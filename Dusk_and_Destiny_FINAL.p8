...
function _init()
    ...
    checkpoint_message_duration = 15
   	life_message_timer = 0
   	life_message_duration = 30 
...
function apply_difficulty()
    if difficulty == "easy" then
        ...
        countdown_timer = 13*60
        carmilla.lives = 5
    elseif difficulty == "hard" then
        anim_timer = 0  -- global anim_timer for npc animation
        countdown_timer = 7*60
        carmilla.lives = 3
    end
end
...
items = {
    ...
    {
        x=125*8, y=12*8, -- change back to 127*8, y=12*8
        w = 8, h = 8,
        name = "key",
        sprite = 11,
        picked = false,
    ...
    {
        x=62*8, y=8*8, -- change back to x=85*8, y=9*8,
        w = 8, h = 8,
        name = "garlic",
        sprite = 10,
        picked = false
...
for key, npc in pairs(npcs) do
    ...
    draw = function()
        ...
        if life_message_timer > 0 then
        			life_message_timer -= 1
        			local message = "-life"
        			local draw_x = carmilla.x - cam_x
           local draw_y = carmilla.y - cam_y - 10
        			color(8)			
        			print(message, draw_x - (#message * 2), draw_y + 1, 5)  -- shadow
           print(message, draw_x - (#message * 2), draw_y, 7)   
        end
...
function update_carmilla()
    ...
    if carmilla.gliding then
    if carmilla.dx > 1 then
        carmilla.dx = 0.9
    elseif carmilla.dx < -1 then
        carmilla.dx = - 0.9
    end
	end
    ...
    if carmilla.x < map_start then
        player.x = map_start
    end

    if carmilla.x > map_end - carmilla.w then
        carmilla.x = map_end - carmilla.w
    end
    ...
    for item in all(items) do
        ...
        carmilla.y + carmilla.h > item.y then
            ...
            if item.name == "garlic" and not carmilla.has_gloves then
                carmilla.lives -= 1
																life_message_timer = life_message_duration 
...

...

...

...

...

...

...

__sfx__
